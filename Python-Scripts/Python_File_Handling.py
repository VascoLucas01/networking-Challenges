...
#Script : Python_File_Handling.py
#Purpose: Using file handling commands, create a new .txt file, appends three lines, prints to the screen the first line, then deletes the .txt file.
